...
CREATE TABLE IF NOT EXISTS `amc_alc_services` (
  ...
  `petrol_charges` decimal(25,2) DEFAULT '0.00',
  `spare_parts_price` decimal(25,2) DEFAULT '0.00',
  `labour_charges` decimal(25,2) DEFAULT '0.00',
  `total_expenses` decimal(25,2) DEFAULT '0.00',
  ...
  `amount_collected` decimal(25,2) DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `call_reports` (
  ...
  -- engineer travel time (Form 2)
  `travel_start_time` time          DEFAULT NULL,
  `travel_reach_time` time          DEFAULT NULL,
  `travel_duration`   int           DEFAULT NULL,
  ...
  `invoice_value`     decimal(25,2) DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `address_2` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `landline_number` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alternate_mobile_number` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `contracts` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `amount_value` decimal(25,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estimate_invoices` (
  ...
  `grand_total` decimal(25,2) DEFAULT '0.00',
  `created_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `total_cgst` decimal(25,2) DEFAULT '0.00',
  `total_sgst` decimal(25,2) DEFAULT '0.00',
  `total_igst` decimal(25,2) DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `sales_targets` (
  ...
  `yearly_target` decimal(25,2) DEFAULT '0.00',
  `monthly_target` decimal(25,2) DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `target_achievements` (
  ...
  `achieved_amount` decimal(25,2) DEFAULT '0.00',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `task_targets` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `carry_forward` decimal(25,2) DEFAULT '0.00',
  `effective_target` decimal(25,2) DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `teammember` (
  ...
  `emp_role` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT 'Sales',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `status` enum('pending','active','rejected','banned') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `emp_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
